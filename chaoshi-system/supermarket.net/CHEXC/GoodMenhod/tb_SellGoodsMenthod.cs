   ...
   public class tb_SellGoodsMenthod
    {
       ...
       public int tb_SellGoodsDelete(tb_SellGoods tbChGood)
       {
           ...
           {
              // string str_Add = "update tb_SellGoods set ";
               string str_Add = "delete from tb_SellGoods  ";
           ...
           try
           {
               ...
               if (objTreeView.GetType().ToString() == "System.Windows.Forms.TreeView")
               {
                   ...
                   while (qlddr.Read())
                   {
                       ...
                       newNode12.Nodes.Add("A",qlddr[3].ToString(), 0, 1);
       ...
       public void fillEmployee(object objTreeView, object obimage)
       {
           try
           {
               ...
               if (objTreeView.GetType().ToString() == "System.Windows.Forms.TreeView")
               {
                   ...
                   TV.ImageList = imlist;
                   System.Windows.Forms.TreeNode TN = new System.Windows.Forms.TreeNode("人员名称", 0, 1);
                   while (qlddr.Read())
                   {
