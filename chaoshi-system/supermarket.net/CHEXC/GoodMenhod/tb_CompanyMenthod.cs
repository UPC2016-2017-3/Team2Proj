    ...
    public class tb_CompanyMenthod
    {
        ...
        public int tb_CompanyMenthodAdd(tb_Company Company)
        {
            ...
            try
            {
              ...
              str_Add+="'"+Company.intCompanyID+"','"+Company.strCompanyName+"',";
              str_Add+="'"+Company.strCompanyPhone+"','"+Company.strCompanyFax+"','"+Company.strCompanyAddress+"',";
              str_Add+="'"+Company.intEmpFalg+"','"+Company.strCompanyDirector+"')";
            ...
            try
            {
                ...
                if (ii != 0)
                {
                    ...
                    while (qlddr.Read())
                    {
                        ...
                        dv[2, i].Value = qlddr[6].ToString();
                        dv[3, i].Value = qlddr[2].ToString();
